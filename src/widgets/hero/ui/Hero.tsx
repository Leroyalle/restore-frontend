        ...
        <div className="grid items-start gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="text-left">
            ...
            <p className="mt-6 max-w-xl text-base text-brand-300/90">
              Самые современные гаджеты и бытовая техника для вашей новой жизни. Только оригинальная
              техника Apple, PlayStation и Dyson с официальной гарантией.
            </p>
          ...
          <div className="relative hidden lg:block">
            <div className="absolute right-8 top-8 h-64 w-64 rounded-full bg-brand-500/30 blur-3xl will-change-transform" />
          </div>
        </div>
      </Container>
    </section>
