...
const customerLinks = ['Сравнение товаров', 'Избранное', 'Корзина', 'Личный кабинет']
        ...
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          <div>
            ...
            <p className="mt-4 text-sm text-text-muted">
              Перезагрузите свои технологии. Откройте мир инноваций с нашими
              премиальными устройствами.
            </p>
          ...
          <FooterColumn title="Каталог" items={catalogLinks} />
  ...
  return (
    <div>
      ...
      <ul className="mt-4 space-y-3 text-sm text-text-muted">
        {items.map((item) => (
          <li key={item} className="transition hover:text-text-primary">
            {item}
          </li>
        ))}
      </ul>
